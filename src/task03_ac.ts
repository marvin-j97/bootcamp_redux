/**
 * Simulates the actions an AC unit can do
...
/**
 * Having no threshold would result in erratic behaviour if the current temperature
 ...
 *
 * If the temperature difference is strictly smaller than the idle threshold, it should idle
 */
